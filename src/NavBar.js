        ...
        <AppBar position="static" className={classes.navBar}>
          <Toolbar>
            ...
            <div className={classes.titleWrapper}>
              <Image className={classes.pdexIcon} src={pdexIcon} alt='PDexLogo'   height='40px' width='40px'/>
            ...
            <FormGroup aria-label="position" row className={classes.apeModeFormGroup}>
              <FormControlLabel
                  control={<PurpleSwitch checked={apeModeActivated} onChange={handleApeModeChange} name="apeMode" classes={{track:classes.switchBaseColor}}
                            icon={<Image className={classes.apeModeOffIcon} src={apeModeIcon} alt='ApeMode Icon'    height='26px' width='26px'/>}
                            checkedIcon={<Image className={classes.apeModeIcon} src={apeModeIcon} alt='ApeMode Icon'    height='26px' width='26px'/>}
                  />}
